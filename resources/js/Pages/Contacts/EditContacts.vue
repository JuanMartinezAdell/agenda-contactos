        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <h1 class="font-semibold text-xl text-gray-800 leading-tight">
                    <span class="text-indigo-700 justify-center mb-2"
                        >Editar
                    </span>
                    / Contacto
                </h1>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="mt-4 mx-8">
                                <Label>
                                    ...
                                    >
                                        <option value="" disabled selected>
                                            Selecciona servicio al que pertenece
                                        </option>
                                        <option
                            ...
                            <div class="mt-4 mx-8">
                                ...
                                <InputError
                                    class="mt-2"
                                    :message="form.errors.short_phone"
                                />
                            </div>
                            <div class="mt-4 mx-8">
                                <InputLabel
                                    for="phone_code"
                                    value="Codigo telefono"
                                />
                                <TextInput
                                    id="phone_code"
